...
public class MD5FileUtil {
    ...
    public synchronized static String getFileMD5String(File file) throws IOException {
        String md5 = String.format("%s,%s",file.getName(),file.length());
        return Hashing.md5().newHasher().putString(md5, Charsets.UTF_8).hash().toString();
    }

    public synchronized static String getFileMD5String2(File file) throws IOException {
